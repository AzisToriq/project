...
<head>
    ...
    <title>SIAKAD PRO - Login Wali Murid</title>
    ...
    <style>
        /* --- MODIFIKASI WARNA KHUSUS ORTU --- */
        :root {
            --primary-blue: #ea580c; /* Orange */
            --primary-blue-dark: #c2410c;
            --primary-green: #d97706; /* Amber/Yellowish */
            --primary-green-dark: #b45309;
        ...
        /* --- SISA CSS SAMA PERSIS (Copas dari file login.blade.php) --- */
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .custom-input:focus { outline: none; border-color: var(--primary-blue); background-color: white; box-shadow: 0 0 0 3px rgba(234, 88, 12, 0.1); }
...
<body>
    <div class="background-container">
        ...
        <div class="floating-elements">
            <div class="floating-element"><i class="fas fa-home"></i></div>
            <div class="floating-element"><i class="fas fa-users"></i></div>
            <div class="floating-element"><i class="fas fa-heart"></i></div>
            <div class="floating-element"><i class="fas fa-clipboard-list"></i></div>
            <div class="floating-element"><i class="fas fa-child"></i></div>
        </div>
    </div>
    ...
    <div class="main-container">
        <div class="info-panel">
            <div class="logo-container">
                ...
                <div class="logo-text">
                    <h1>PORTAL ORTU</h1>
                    <p>Wali Murid Dashboard</p>
                </div>
            </div>

            <div class="info-content">
                <h2 class="info-title">Pantau Perkembangan Buah Hati Anda</h2>
                <p class="info-description">
                    Dapatkan informasi terkini mengenai kehadiran, nilai akademik, dan administrasi sekolah anak Anda secara real-time.
                </p>

                <div class="features">
                    <div class="feature"><div class="feature-icon"><i class="fas fa-check-circle"></i></div><div class="feature-text">Monitoring Absensi Harian</div></div>
                    <div class="feature"><div class="feature-icon"><i class="fas fa-file-invoice-dollar"></i></div><div class="feature-text">Informasi Tagihan & SPP</div></div>
                    <div class="feature"><div class="feature-icon"><i class="fas fa-star"></i></div><div class="feature-text">Lihat Nilai Rapor Siswa</div></div>
                </div>
            </div>

            <div class="info-footer">
                <p>© 2025 SIAKAD PRO. Parent Portal.</p>
            </div>
        </div>

        <div class="login-panel">
            <div class="login-header">
                <h2 class="login-title">Login Wali Murid</h2>
                <p class="login-subtitle">Masuk menggunakan email yang terdaftar</p>
            </div>
            ...
            <div class="form-container">
                <form method="POST" action="{{ route('ortu.authenticate') }}" id="loginForm">
                    @csrf

                    <div class="input-group">
                        <label for="email" class="input-label">Email Orang Tua</label>
                        <div class="input-container">
                            <div class="input-icon"><i class="fas fa-envelope"></i></div>
                            <input id="email" type="email" name="email" value="{{ old('email') }}"
                                   class="custom-input @error('email') error @enderror"
                                   placeholder="ortu.siswa@sekolah.com" required autofocus>
                    ...
                    <button type="submit" class="btn-primary" id="submitBtn">
                        ...
                        <span>MASUK SEBAGAI WALI</span>
                    </button>
                </form>
            </div>

            <div class="login-footer">
                <p>Bukan Wali Murid? <a href="{{ route('siswa.login') }}">Login Siswa</a></p>
            </div>
        </div>
    </div>
